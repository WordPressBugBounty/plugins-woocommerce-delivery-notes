...
class ComposerStaticInita44f2cb79329ce99e54227132018137a
{
    ...
    public static $classMap = array (
        ...
        'Tyche\\WCDN\\Admin' => __DIR__ . '/../..' . '/includes/admin/class-admin.php',
        'Tyche\\WCDN\\Admin_Component' => __DIR__ . '/../..' . '/includes/component/class-admin-component.php',
        'Tyche\\WCDN\\Api\\Api' => __DIR__ . '/../..' . '/includes/api/class-api.php',
        'Tyche\\WCDN\\Api\\Dashboard' => __DIR__ . '/../..' . '/includes/api/class-dashboard.php',
        'Tyche\\WCDN\\Api\\Fonts' => __DIR__ . '/../..' . '/includes/api/class-fonts.php',
        'Tyche\\WCDN\\Api\\Settings' => __DIR__ . '/../..' . '/includes/api/class-settings.php',
        'Tyche\\WCDN\\Api\\Templates' => __DIR__ . '/../..' . '/includes/api/class-templates.php',
        'Tyche\\WCDN\\Backend' => __DIR__ . '/../..' . '/includes/admin/class-backend.php',
        'Tyche\\WCDN\\Files' => __DIR__ . '/../..' . '/includes/core/class-files.php',
        'Tyche\\WCDN\\Frontend' => __DIR__ . '/../..' . '/includes/frontend/class-frontend.php',
        'Tyche\\WCDN\\Helpers\\Helper' => __DIR__ . '/../..' . '/includes/helpers/class-helper.php',
        'Tyche\\WCDN\\Helpers\\Settings' => __DIR__ . '/../..' . '/includes/helpers/class-settings.php',
        'Tyche\\WCDN\\Helpers\\Templates' => __DIR__ . '/../..' . '/includes/helpers/class-templates.php',
        'Tyche\\WCDN\\Helpers\\Utils' => __DIR__ . '/../..' . '/includes/helpers/class-utils.php',
        'Tyche\\WCDN\\Hooks' => __DIR__ . '/../..' . '/includes/core/class-hooks.php',
        'Tyche\\WCDN\\Install' => __DIR__ . '/../..' . '/includes/core/class-install.php',
        'Tyche\\WCDN\\Integrations\\Coderockz_Woo_Delivery' => __DIR__ . '/../..' . '/includes/integrations/class-coderockz-woo-delivery.php',
        'Tyche\\WCDN\\Integrations\\DFW_Deposits' => __DIR__ . '/../..' . '/includes/integrations/class-dfw-deposits.php',
        'Tyche\\WCDN\\Integrations\\Deposits_Partial_Payments' => __DIR__ . '/../..' . '/includes/integrations/class-deposits-partial-payments.php',
        'Tyche\\WCDN\\Integrations\\Emails' => __DIR__ . '/../..' . '/includes/integrations/class-emails.php',
        'Tyche\\WCDN\\Integrations\\Local_Pickup_Plus' => __DIR__ . '/../..' . '/includes/integrations/class-local-pickup-plus.php',
        'Tyche\\WCDN\\Menu' => __DIR__ . '/../..' . '/includes/admin/class-menu.php',
        'Tyche\\WCDN\\Migration' => __DIR__ . '/../..' . '/includes/core/class-migration.php',
        'Tyche\\WCDN\\Notices' => __DIR__ . '/../..' . '/includes/admin/class-notices.php',
        'Tyche\\WCDN\\Scripts' => __DIR__ . '/../..' . '/includes/admin/class-scripts.php',
        'Tyche\\WCDN\\Service' => __DIR__ . '/../..' . '/includes/services/class-service.php',
        'Tyche\\WCDN\\Services\\Pdf' => __DIR__ . '/../..' . '/includes/services/class-pdf.php',
        'Tyche\\WCDN\\Services\\Template_Engine' => __DIR__ . '/../..' . '/includes/services/template/class-template-engine.php',
        'Tyche\\WCDN\\Services\\Template_Renderer' => __DIR__ . '/../..' . '/includes/services/template/class-template-renderer.php',
        'Tyche\\WCDN\\Services\\Template_Style' => __DIR__ . '/../..' . '/includes/services/template/class-template-style.php',
        'Tyche\\WCDN\\Tyche_Plugin_Deactivation' => __DIR__ . '/../..' . '/includes/component/plugin-deactivation/class-tyche-plugin-deactivation.php',
        'Tyche\\WCDN\\Tyche_Plugin_Tracking' => __DIR__ . '/../..' . '/includes/component/plugin-tracking/class-tyche-plugin-tracking.php',
        'Tyche\\WCDN\\Uninstall' => __DIR__ . '/../..' . '/includes/core/class-uninstall.php',
        'Tyche\\WCDN\\WooCommerce_Delivery_Notes' => __DIR__ . '/../..' . '/includes/class-woocommerce-delivery-notes.php',
    );
