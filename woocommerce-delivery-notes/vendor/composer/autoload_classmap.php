...
return array(
    ...
    'Tyche\\WCDN\\Admin' => $baseDir . '/includes/admin/class-admin.php',
    'Tyche\\WCDN\\Admin_Component' => $baseDir . '/includes/component/class-admin-component.php',
    'Tyche\\WCDN\\Api\\Api' => $baseDir . '/includes/api/class-api.php',
    'Tyche\\WCDN\\Api\\Dashboard' => $baseDir . '/includes/api/class-dashboard.php',
    'Tyche\\WCDN\\Api\\Fonts' => $baseDir . '/includes/api/class-fonts.php',
    'Tyche\\WCDN\\Api\\Settings' => $baseDir . '/includes/api/class-settings.php',
    'Tyche\\WCDN\\Api\\Templates' => $baseDir . '/includes/api/class-templates.php',
    'Tyche\\WCDN\\Backend' => $baseDir . '/includes/admin/class-backend.php',
    'Tyche\\WCDN\\Files' => $baseDir . '/includes/core/class-files.php',
    'Tyche\\WCDN\\Frontend' => $baseDir . '/includes/frontend/class-frontend.php',
    'Tyche\\WCDN\\Helpers\\Helper' => $baseDir . '/includes/helpers/class-helper.php',
    'Tyche\\WCDN\\Helpers\\Settings' => $baseDir . '/includes/helpers/class-settings.php',
    'Tyche\\WCDN\\Helpers\\Templates' => $baseDir . '/includes/helpers/class-templates.php',
    'Tyche\\WCDN\\Helpers\\Utils' => $baseDir . '/includes/helpers/class-utils.php',
    'Tyche\\WCDN\\Hooks' => $baseDir . '/includes/core/class-hooks.php',
    'Tyche\\WCDN\\Install' => $baseDir . '/includes/core/class-install.php',
    'Tyche\\WCDN\\Integrations\\Emails' => $baseDir . '/includes/integrations/class-emails.php',
    'Tyche\\WCDN\\Menu' => $baseDir . '/includes/admin/class-menu.php',
    'Tyche\\WCDN\\Migration' => $baseDir . '/includes/core/class-migration.php',
    'Tyche\\WCDN\\Notices' => $baseDir . '/includes/admin/class-notices.php',
    'Tyche\\WCDN\\Scripts' => $baseDir . '/includes/admin/class-scripts.php',
    'Tyche\\WCDN\\Service' => $baseDir . '/includes/services/class-service.php',
    'Tyche\\WCDN\\Services\\Pdf' => $baseDir . '/includes/services/class-pdf.php',
    'Tyche\\WCDN\\Services\\Template_Engine' => $baseDir . '/includes/services/template/class-template-engine.php',
    'Tyche\\WCDN\\Services\\Template_Renderer' => $baseDir . '/includes/services/template/class-template-renderer.php',
    'Tyche\\WCDN\\Services\\Template_Style' => $baseDir . '/includes/services/template/class-template-style.php',
    'Tyche\\WCDN\\Tyche_Plugin_Deactivation' => $baseDir . '/includes/component/plugin-deactivation/class-tyche-plugin-deactivation.php',
    'Tyche\\WCDN\\Tyche_Plugin_Tracking' => $baseDir . '/includes/component/plugin-tracking/class-tyche-plugin-tracking.php',
    'Tyche\\WCDN\\Uninstall' => $baseDir . '/includes/core/class-uninstall.php',
    'Tyche\\WCDN\\WooCommerce_Delivery_Notes' => $baseDir . '/includes/class-woocommerce-delivery-notes.php',
);
